...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('files', '0008_alter_file_creator_alter_file_entity_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='image',
            name='file_ptr',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='%(app_label)s_%(class)s_related', serialize=False, to='files.file'),
        ),
    ]
